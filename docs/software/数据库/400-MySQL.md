...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200609220650859.jpg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM0ODMzNTk5,size_16,color_FFFFFF,t_70#pic_center)
...
![字符串函数](https://imgconvert.csdnimg.cn/aHR0cDovL25vdGVib29rLnpoYW5namlhaGFvLnNpdGUvbWFya2Rvd24taW1nLXBhc3RlLTIwMjAwNDI3MjA0OTI0MTI5LnBuZw?x-oss-process=image/format,png)
...
![数值函数](https://imgconvert.csdnimg.cn/aHR0cDovL25vdGVib29rLnpoYW5namlhaGFvLnNpdGUvbWFya2Rvd24taW1nLXBhc3RlLTIwMjAwNDI3MjE0MzA3ODAwLnBuZw?x-oss-process=image/format,png)

### 时间和日期函数

![时间和日期函数](https://imgconvert.csdnimg.cn/aHR0cDovL25vdGVib29rLnpoYW5namlhaGFvLnNpdGUvbWFya2Rvd24taW1nLXBhc3RlLTIwMjAwNDI3MjE0NDA4NDQucG5n?x-oss-process=image/format,png)
...
> ![DATE_FORMART](https://imgconvert.csdnimg.cn/aHR0cDovL25vdGVib29rLnpoYW5namlhaGFvLnNpdGUvbWFya2Rvd24taW1nLXBhc3RlLTIwMjAwNDI3MjE1MzE3NTM4LnBuZw?x-oss-process=image/format,png) > ![DATE_FORMART](https://imgconvert.csdnimg.cn/aHR0cDovL25vdGVib29rLnpoYW5namlhaGFvLnNpdGUvbWFya2Rvd24taW1nLXBhc3RlLTIwMjAwNDI3MjE1NDAxMjQ3LnBuZw?x-oss-process=image/format,png)

> ![](https://imgconvert.csdnimg.cn/aHR0cDovL25vdGVib29rLnpoYW5namlhaGFvLnNpdGUvbWFya2Rvd24taW1nLXBhc3RlLTIwMjAwNDI3MjE1NDM3MTY0LnBuZw?x-oss-process=image/format,png)

### 流程函数

![流程函数](https://imgconvert.csdnimg.cn/aHR0cDovL25vdGVib29rLnpoYW5namlhaGFvLnNpdGUvbWFya2Rvd24taW1nLXBhc3RlLTIwMjAwNDI3MjE1NTI3NTM1LnBuZw?x-oss-process=image/format,png)

### 其他函数

![其他函数](https://imgconvert.csdnimg.cn/aHR0cDovL25vdGVib29rLnpoYW5namlhaGFvLnNpdGUvbWFya2Rvd24taW1nLXBhc3RlLTIwMjAwNDI3MjE1NjMyMjk2LnBuZw?x-oss-process=image/format,png)
...
![存储引擎对比](https://imgconvert.csdnimg.cn/aHR0cDovL25vdGVib29rLnpoYW5namlhaGFvLnNpdGUvbWFya2Rvd24taW1nLXBhc3RlLTIwMjAwNDI4MDkyMTE5MzU4LnBuZw?x-oss-process=image/format,png)
...
- 事务隔离级别： - 更新丢失问题：需要在应用端添加锁，来防止更新丢失 - 脏读、不可重复读、幻读：都是数据库读一致性问题，采用数据库的事务隔离机制实现 - 在读数据之前加锁 - 通过一定机制生成一致性数据快照，从而实现读一致性 - ![](http://notebook.zhangjiahao.site/20200622134007.png)
...
> `show status 'Com_%';` > ![20200508164023.png](https://imgconvert.csdnimg.cn/aHR0cDovL25vdGVib29rLnpoYW5namlhaGFvLnNpdGUvMjAyMDA1MDgxNjQwMjMucG5n?x-oss-process=image/format,png)
...
- ![20200508225957.png](https://imgconvert.csdnimg.cn/aHR0cDovL25vdGVib29rLnpoYW5namlhaGFvLnNpdGUvMjAyMDA1MDgyMjU5NTcucG5n?x-oss-process=image/format,png)
