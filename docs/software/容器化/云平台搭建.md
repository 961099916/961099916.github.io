...
- 添加集群
  ![创建](http://notebook.zhangjiahao.site/20200527100807.png)
- 选择自定义，然后填写创建的配置，点击下一步
- ![选择](http://notebook.zhangjiahao.site/20200527101008.png)
- 添加节点
- ![添加](http://notebook.zhangjiahao.site/20200527101120.png)
...
![选择](http://notebook.zhangjiahao.site/20200601084108.png)
![添加key](http://notebook.zhangjiahao.site/20200601084145.png)
![完成](http://notebook.zhangjiahao.site/20200601084228.png)
...
![Global Tool Configure](http://notebook.zhangjiahao.site/20200604085715.png)

### 设置流水线

- 新建 Item
- ![新建Item](http://notebook.zhangjiahao.site/20200604085858.png)
- 选择创建任务的类型和名称
- ![选择创建任务的类型和名称](http://notebook.zhangjiahao.site/20200604085932.png)
- 配置源码管理
- ![配置源码管理](http://notebook.zhangjiahao.site/20200604103747.png)
- 构建触发器：可设置定时构建、WebHooks 触发构建
- 构建环境：需要 NodeJs 的可以添加环境，或者直接在脚本中直接通过 node 的位置直接执行
- ![构建触发器](http://notebook.zhangjiahao.site/20200604103930.png)
- build 命令：可指定文件执行 maven 命令
- Post Steps: 可以指定运行脚本等，根据安装的插件可添加很多功能
- 构建设置：可设置通知
- ![build命令](http://notebook.zhangjiahao.site/20200604104123.png)
...
- 添加源码管理并指定分支
- ![添加源码管理](http://notebook.zhangjiahao.site/20200604104649.png)
- 项目中使用到了 NodeJs，添加 NodeJs 构建环境
- ![添加NodeJs构建环境](http://notebook.zhangjiahao.site/20200604104757.png)
- 执行 Maven 命令进行构建打包
- ![执行Maven命令进行构建打包](http://notebook.zhangjiahao.site/20200604104837.png)
- 执行自定义（deploy）制作镜像-->推送镜像--->部署的脚本
- ![执行自定义](http://notebook.zhangjiahao.site/20200604104859.png)
- 点击应用，保存该流水线。
- deploy 内容
...
- 点击 Build Now 运行流水线
- ![Now运行流水线](http://notebook.zhangjiahao.site/20200604105054.png)
- 点击历史可进入正在运行的流水线
- ![点击历史可进入正在运行的流水线](http://notebook.zhangjiahao.site/20200604105137.png)
- 通过控制台进行查看流水线日志
- ![通过控制台进行查看流水线日志](http://notebook.zhangjiahao.site/20200604105217.png)

### 查看 Kubernetes 集群中是否部署成功

- 查看指定的命名空间和服务名称
- ![查看指定的命名空间和服务名称](http://notebook.zhangjiahao.site/20200604105939.png)
