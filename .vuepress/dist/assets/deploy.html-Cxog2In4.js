...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("ol", null, [
      ...
      _hoisted_12,
      createBaseVNode("li", null, [
        createTextVNode("在根目录下创建 "),
        _hoisted_14,
        createTextVNode("（"),
        createBaseVNode("a", _hoisted_15, [
          createTextVNode("配置规范"),
          createVNode(_component_ExternalLinkIcon)
        ]),
        createTextVNode("）："),
        _hoisted_16
    ...
    createBaseVNode("ol", null, [
      ...
      createBaseVNode("li", null, [
        createTextVNode("由于 "),
        _hoisted_23,
        createTextVNode(" 自带 CI，所以就省去了很多的配置步骤，只需要在项目根目录创建 "),
        _hoisted_24,
        createTextVNode("（"),
...
const deploy_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "deploy.html.vue"]]);
export {
  deploy_html as default
};
