import { _ as _export_sfc, r as resolveComponent, o as openBlock, c as createElementBlock, a as createBaseVNode, b as createTextVNode, d as createVNode, e as createStaticVNode } from "./app-DLH3w5yF.js";
const _sfc_main = {};
const _hoisted_1 = { class: "custom-container tip" };
const _hoisted_2 = /* @__PURE__ */ createStaticVNode('<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"></circle><path d="M12 8h.01"></path><path d="M11 12h1v4h1"></path></g></svg><p class="custom-container-title">TIP</p><p>Valine Admin 是 Valine 评论系统的扩展和增强，主要实现评论邮件通知、评论管理、垃圾评论过滤等功能。支持完全自定义的邮件通知模板，基于Akismet API实现准确的垃圾评论过滤。</p>', 3);
const _hoisted_5 = {
...
const _hoisted_6 = /* @__PURE__ */ createBaseVNode(
  ...
  [
    ...
    /* @__PURE__ */ createTextVNode(' 云引擎"一键"部署')
  ],
  -1
  /* HOISTED */
);
const _hoisted_7 = /* @__PURE__ */ createBaseVNode(
  ...
  [
    ...
    /* @__PURE__ */ createTextVNode(" 1. 填写代码库")
  ],
  -1
  /* HOISTED */
);
const _hoisted_8 = {
  href: "https://leancloud.cn/dashboard/#/apps",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_9 = {
  href: "https://github.com/DesertsP/Valine-Admin.git",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_10 = {
...
const _hoisted_11 = {
  href: "https://github.com/ComicAuthor/Valine-Admin",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_12 = /* @__PURE__ */ createBaseVNode(
  "a",
  { href: "#%E6%94%B9%E7%BC%96%E7%89%88%E6%9C%AC%E5%86%85%E5%AE%B9%E4%BB%8B%E7%BB%8D" },
  "点击",
  -1
  /* HOISTED */
);
const _hoisted_13 = /* @__PURE__ */ createStaticVNode('<br><img src="https://i.loli.net/2020/07/19/BCxjLA68ZOEtID7.png" alt="填写代码库" width="600" style="display:block;margin:auto;"><br><img src="https://i.loli.net/2020/07/19/53bpWmS2MAJIXf9.png" alt="填写代码库" width="600" style="display:block;margin:auto;"><h3 id="_2-在设置页面-设置环境变量以及-web-二级域名。" tabindex="-1"><a class="header-anchor" href="#_2-在设置页面-设置环境变量以及-web-二级域名。" aria-hidden="true">#</a> 2.在设置页面，设置环境变量以及 Web 二级域名。</h3><img src="https://i.loli.net/2020/07/19/qZBdJPEmLzx5Oo6.png" alt="设置环境变量" width="600" style="display:block;margin:auto;"><p>具体格式如下：</p>', 7);
const _hoisted_20 = /* @__PURE__ */ createBaseVNode(
  "thead",
  null,
  [
    /* @__PURE__ */ createBaseVNode("tr", null, [
      /* @__PURE__ */ createBaseVNode("th", { style: { "text-align": "center" } }, "变量"),
      /* @__PURE__ */ createBaseVNode("th", { style: { "text-align": "center" } }, "示例"),
      /* @__PURE__ */ createBaseVNode("th", { style: { "text-align": "center" } }, "说明")
    ])
  ],
  -1
  /* HOISTED */
...
const _hoisted_21 = /* @__PURE__ */ createBaseVNode(
  ...
  null,
  [
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "SITE_NAME"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "平凡的你我"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "[必填]博客名称")
  ],
  -1
  /* HOISTED */
);
...
const _hoisted_26 = /* @__PURE__ */ createBaseVNode(
  ...
  { style: { "text-align": "center" } },
  [
    /* @__PURE__ */ createBaseVNode("strong", null, "SMTP_SERVICE")
  ],
  -1
  /* HOISTED */
);
...
const _hoisted_29 = {
  href: "https://nodemailer.com/smtp/well-known/#supported-services",
  target: "_blank",
  rel: "noopener noreferrer"
};
...
const _hoisted_31 = /* @__PURE__ */ createBaseVNode(
  ...
  null,
  [
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "SMTP_USER"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "xxxxx@163.com"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "[必填]SMTP登录用户")
  ],
  -1
  /* HOISTED */
);
const _hoisted_32 = /* @__PURE__ */ createBaseVNode(
  ...
  null,
  [
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "SMTP_PASS"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "XXXXXXXX"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "[必填]SMTP登录密码（QQ邮箱需要获取独立密码）")
  ],
  -1
  /* HOISTED */
);
const _hoisted_33 = /* @__PURE__ */ createBaseVNode(
  ...
  null,
  [
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "SENDER_NAME"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "caleb"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "[必填]发件人")
  ],
  -1
  /* HOISTED */
);
const _hoisted_34 = /* @__PURE__ */ createBaseVNode(
  ...
  null,
  [
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "SENDER_EMAIL"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "xxxxx@163.com"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "[必填]发件邮箱")
  ],
  -1
  /* HOISTED */
);
const _hoisted_35 = /* @__PURE__ */ createBaseVNode(
  ...
  null,
  [
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "BLOGGER_EMAIL"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "xxxxx@163.com"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "[可选]如果自己在回复，设置这个可以不向自己的邮箱发送邮件 && 博主通知收件地址，默认使用SENDER_EMAIL")
  ],
  -1
  /* HOISTED */
);
const _hoisted_36 = /* @__PURE__ */ createBaseVNode(
  ...
  null,
  [
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "ADMIN_URL"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "https://xxx.leanapp.cn/"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "[建议]Web主机二级域名，用于自动唤醒")
  ],
  -1
  /* HOISTED */
);
const _hoisted_37 = /* @__PURE__ */ createBaseVNode(
  ...
  null,
  [
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "AKISMET_KEY"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "xxxxxxxxxxxx"),
    /* @__PURE__ */ createBaseVNode("td", { style: { "text-align": "center" } }, "[可选]Akismet Key 用于垃圾评论检测，设为MANUAL_REVIEW开启人工审核，留空不使用反垃圾")
  ],
  -1
  /* HOISTED */
);
const _hoisted_38 = /* @__PURE__ */ createStaticVNode('<p><strong>以上必填参数请务必正确设置。</strong></p><h3 id="_3-切换到部署标签页-分支使用master-点击部署即可" tabindex="-1"><a class="header-anchor" href="#_3-切换到部署标签页-分支使用master-点击部署即可" aria-hidden="true">#</a> 3.切换到部署标签页，分支使用master，点击部署即可</h3><img src="https://i.loli.net/2020/07/19/Gl28hq1UsHZ6F9L.png" alt="部署" width="600" style="display:block;margin:auto;"><p>第一次部署可能会需要些时间。</p><img src="https://i.loli.net/2020/07/19/icCQWGbaAlNdjPB.png" alt="部署日志" width="600" style="display:block;margin:auto;"><h3 id="_4-评论管理" tabindex="-1"><a class="header-anchor" href="#_4-评论管理" aria-hidden="true">#</a> 4.评论管理</h3>', 6);
const _hoisted_44 = {
  id: "访问设置的二级域名https-二级域名-leanapp-cn-sign-up-注册管理员登录信息-如-https-nk6vtvs0tdwc-leanapp-cn-sign-up",
  tabindex: "-1"
};
const _hoisted_45 = /* @__PURE__ */ createBaseVNode(
  ...
  {
    class: "header-anchor",
    href: "#访问设置的二级域名https-二级域名-leanapp-cn-sign-up-注册管理员登录信息-如-https-nk6vtvs0tdwc-leanapp-cn-sign-up",
    "aria-hidden": "true"
  },
  "#",
  -1
...
const _hoisted_93 = /* @__PURE__ */ createStaticVNode('<img src="https://i.loli.net/2020/07/19/WPHmEcjfdzM7y9r.png" alt="个人中心" width="600" style="display:block;margin:auto;"><p>看到接口地址后将 <code>send/</code> 之后的内容复制下来，填写进 <code>QMSG_KEY</code> 变量中。</p><img src="https://i.loli.net/2020/07/19/gc8Aad5ZmNP3fIk.png" alt="接口地址" width="600" style="display:block;margin:auto;"><h3 id="qmsg模板" tabindex="-1"><a class="header-anchor" href="#qmsg模板" aria-hidden="true">#</a> Qmsg模板</h3><p>初始化模板样式如下：</p><img src="https://i.loli.net/2020/07/19/tWilU9OCqAdbx6H.png" alt="QMSG_TEMPLATE" width="600" style="display:block;margin:auto;"><p>如果你并不不喜欢当前的样式，这里为您抛出了一些接口供您自定义模板：</p><table><thead><tr><th style="text-align:center;">变量</th><th style="text-align:center;">说明</th></tr></thead><tbody><tr><td style="text-align:center;">SITE_NAME</td><td style="text-align:center;">[可选]站点名称</td></tr><tr><td style="text-align:center;">NICK</td><td style="text-align:center;">[可选]评论者名称</td></tr><tr><td style="text-align:center;">comment</td><td style="text-align:center;">[必填]评论信息</td></tr><tr><td style="text-align:center;">POST_URL</td><td style="text-align:center;">[可选]对应的评论地址</td></tr></tbody></table><p><strong>使用字符串拼接方法，将变量放入其中</strong></p><p>参考如下：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">您在 </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">${</span><span class="token constant">SITE_NAME</span><span class="token interpolation-punctuation punctuation">}</span></span><span class="token string"> 上有新评论啦！\n</span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">${</span><span class="token constant">NICK</span><span class="token interpolation-punctuation punctuation">}</span></span><span class="token string"> 给您的回复如下：[CQ:emoji,id=11015]\n           \n    [CQ:face,id=12] </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">${</span>comment<span class="token interpolation-punctuation punctuation">}</span></span><span class="token string">\n        \n您可以点击 </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">${</span><span class="token constant">POST_URL</span><span class="token interpolation-punctuation punctuation">}</span></span><span class="token string"> 前去查看！</span><span class="token template-punctuation string">`</span></span>\n</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>同时您还可以使用QQ表情用来点缀您的信息模板。使用方法为 <code>[CQ:face,id=XX]</code> ,其中XX为下图的表情序号。</p><img src="https://i.loli.net/2020/07/19/Sro5UpwiPBGHKsY.png" alt="表情" width="600" style="display:block;margin:auto;"><p>如果你觉得QQ表情不是特别好看的话，您可以使用QQ里面的emoji表情。使用方法为 <code>[CQ:emoji,id=XX]</code> ,其中XX为emoji表情序号。</p>', 14);
const _hoisted_107 = {
  href: "https://cqp.cc/t/15827/",
  target: "_blank",
  rel: "noopener noreferrer"
};
...
const _hoisted_109 = /* @__PURE__ */ createStaticVNode('<h3 id="qq戳一戳" tabindex="-1"><a class="header-anchor" href="#qq戳一戳" aria-hidden="true">#</a> QQ戳一戳</h3><p>如果想开启戳一戳提示的话，就设置true。</p><h2 id="server酱" tabindex="-1"><a class="header-anchor" href="#server酱" aria-hidden="true">#</a> Server酱</h2><h3 id="申请sc-key" tabindex="-1"><a class="header-anchor" href="#申请sc-key" aria-hidden="true">#</a> 申请SC_KEY</h3>', 4);
const _hoisted_113 = {
...
const _hoisted_116 = /* @__PURE__ */ createStaticVNode('<img src="https://i.loli.net/2020/07/19/DpXSO96R8gFHCmk.png" alt="微信绑定" width="600" style="display:block;margin:auto;"><p>测试微信推送正常以后，点击 <code>发送消息</code> 进入页面。可以看到 <code>SCKEY</code> 复制粘贴到变量 <code>SC_KEY</code> 中。</p><img src="https://i.loli.net/2020/07/19/mhfROXjAITVL58y.png" alt="查看SCKEY" width="600" style="display:block;margin:auto;"><h3 id="消息-标题-内容-模板" tabindex="-1"><a class="header-anchor" href="#消息-标题-内容-模板" aria-hidden="true">#</a> 消息 标题/内容 模板</h3><p>初始化模板样式如下：</p><img src="https://i.loli.net/2020/07/19/sCcjfIzUpvDdknh.png" alt="标题模板" width="600" style="display:block;margin:auto;"><h3 id="自定义-标题-内容-模板" tabindex="-1"><a class="header-anchor" href="#自定义-标题-内容-模板" aria-hidden="true">#</a> 自定义 标题/内容 模板</h3><p>抛出的接口：</p><table><thead><tr><th style="text-align:center;">变量</th><th style="text-align:center;">说明</th></tr></thead><tbody><tr><td style="text-align:center;">SITE_NAME</td><td style="text-align:center;">[可选]站点名称</td></tr><tr><td style="text-align:center;">NICK</td><td style="text-align:center;">[可选]评论者名称</td></tr><tr><td style="text-align:center;">COMMENT</td><td style="text-align:center;">[必填]评论信息</td></tr><tr><td style="text-align:center;">POST_URL</td><td style="text-align:center;">[可选]对应的评论地址</td></tr></tbody></table><p><strong>使用字符串拼接方法，将变量放入其中</strong></p><p>消息标题模板参考：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">您在 </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">${</span><span class="token constant">SITE_NAME</span><span class="token interpolation-punctuation punctuation">}</span></span><span class="token string"> 上有新评论啦！</span><span class="token template-punctuation string">`</span></span>\n</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>消息内容模板参考：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">#### </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">${</span><span class="token constant">NICK</span><span class="token interpolation-punctuation punctuation">}</span></span><span class="token string"> 给您的回复如下：\n        \n&gt; </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">${</span><span class="token constant">COMMENT</span><span class="token interpolation-punctuation punctuation">}</span></span><span class="token string">\n        \n#### 您可以点击[查看回复的完整內容](</span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">${</span><span class="token constant">POST_URL</span><span class="token interpolation-punctuation punctuation">}</span></span><span class="token string">)</span><span class="token template-punctuation string">`</span></span>\n</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>变量 <code>SC_DESP_TEMPLATE</code> 支持MarkDown。但是最大只有64K，请提前注意。</p><blockquote><p>注意这里的 COMMENT 与 QQ消息模板中的 comment 并不相同，请注意分别。</p></blockquote><h2 id="改编版本内容介绍" tabindex="-1"><a class="header-anchor" href="#改编版本内容介绍" aria-hidden="true">#</a> 改编版本内容介绍</h2><p><strong>Version 1.0.2</strong></p><ol><li>增加了QQ提醒功能(Qmsg酱)</li><li>增加了微信提醒功能(Server酱)</li></ol><p><strong>Version 1.0.1</strong></p><ol><li>增加了用户头像的判断 QQ头像以及gravatar头像</li><li>增加了分页插件</li><li>增加了博主/全部列表的展示</li><li>增加了返回顶部按钮</li><li>不断升级中~~~</li></ol><p><strong>以上所有内容供大家参考，有问题请及时指正，如有侵权，请及时联系删除</strong></p>', 22);
const _hoisted_138 = { class: "custom-container tip" };
...
const _hoisted_141 = {
  href: "https://github.com/ComicAuthor",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_142 = {
...
const _hoisted_143 = /* @__PURE__ */ createBaseVNode(
  ...
  [
    ...
    /* @__PURE__ */ createBaseVNode("strong", null, "完结撒花🎉🎉🎉")
  ],
  -1
  /* HOISTED */
);
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("p", null, [
      ...
      createBaseVNode("a", _hoisted_8, [
        createTextVNode("Leancloud"),
        createVNode(_component_ExternalLinkIcon)
      ]),
      createTextVNode("云引擎-->部署界面，填写代码库并保存："),
      createBaseVNode("a", _hoisted_9, [
        createTextVNode("https://github.com/DesertsP/Valine-Admin.git"),
        createVNode(_component_ExternalLinkIcon)
      ])
    ]),
    createBaseVNode("blockquote", null, [
      createBaseVNode("p", null, [
        createTextVNode("也可以使用我根据"),
        createBaseVNode("a", _hoisted_10, [
          createTextVNode("@Deserts"),
          createVNode(_component_ExternalLinkIcon)
        ]),
        createTextVNode("的项目改写的地址： "),
        createBaseVNode("a", _hoisted_11, [
          createTextVNode("https://github.com/ComicAuthor/Valine-Admin"),
          createVNode(_component_ExternalLinkIcon)
        ]),
        createTextVNode("，改编版本内容介绍请"),
        _hoisted_12,
        createTextVNode("。")
      ])
    ]),
      ...
      createBaseVNode("tbody", null, [
        ...
        createBaseVNode("tr", null, [
          ...
          createBaseVNode("td", _hoisted_23, [
            createBaseVNode("a", _hoisted_24, [
              createTextVNode("https://reinness.com"),
              createVNode(_component_ExternalLinkIcon)
            ])
          ]),
          _hoisted_25
        ...
        createBaseVNode("tr", null, [
          ...
          createBaseVNode("td", _hoisted_28, [
            createTextVNode("[新版支持]邮件服务提供商，支持 QQ、163、126、Gmail 以及 "),
    ...
    createBaseVNode("h4", _hoisted_44, [
      ...
      createBaseVNode("s", null, [
        createTextVNode("访问设置的二级域名"),
        _hoisted_46,
        createTextVNode(" ，注册管理员登录信息，如："),
        createBaseVNode("a", _hoisted_47, [
          createTextVNode("https://nk6vtvs0tdwc.leanapp.cn/sign-up"),
          createVNode(_component_ExternalLinkIcon)
        ])
      ])
    ]),
    createBaseVNode("div", _hoisted_48, [
      ...
      createBaseVNode("p", null, [
        ...
        createBaseVNode("a", _hoisted_52, [
          createTextVNode("LeanCloud Blog | 域名绑定 Q&A"),
          createVNode(_component_ExternalLinkIcon)
        ])
      ])
    ]),
    _hoisted_53,
    createBaseVNode("p", null, [
      createTextVNode("首先前往"),
      createBaseVNode("a", _hoisted_91, [
        _hoisted_92,
        createVNode(_component_ExternalLinkIcon)
      ]),
      createTextVNode(",按照官方文档完成相应的注册。并添加「Qmsg酱」小姐姐为QQ好友。然后点击文档按钮。")
    ]),
    _hoisted_93,
    createBaseVNode("p", null, [
    ...
    createBaseVNode("p", null, [
      ...
      createTextVNode(", 通过Github登录。点击 "),
      _hoisted_115,
      createTextVNode(" 完成微信绑定。")
    ]),
    _hoisted_116,
    createBaseVNode("div", _hoisted_138, [
      ...
      createBaseVNode("p", null, [
        ...
        createBaseVNode("a", _hoisted_141, [
          createTextVNode("Caleb"),
          createVNode(_component_ExternalLinkIcon)
        ]),
        createTextVNode("，博客 "),
        createBaseVNode("a", _hoisted_142, [
          createTextVNode("平凡的你我"),
          createVNode(_component_ExternalLinkIcon)
        ]),
        createTextVNode("。")
      ])
...
const valineAdmin_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "valine-admin.html.vue"]]);
export {
  valineAdmin_html as default
};
