import { _ as _export_sfc, r as resolveComponent, o as openBlock, c as createElementBlock, b as createBaseVNode, d as createTextVNode, e as createVNode, a as createStaticVNode } from "./app-Da7dhu-2.js";
const _sfc_main = {};
...
const _hoisted_3 = /* @__PURE__ */ createBaseVNode(
  ...
  [
    /* @__PURE__ */ createBaseVNode("img", {
      src: "https://zhangjiahao-blog.oss-cn-beijing.aliyuncs.com/picgo/202304302221305.png#alt=JVM 主要内容",
      alt: ""
    })
  ],
  -1
...
const _hoisted_4 = /* @__PURE__ */ createBaseVNode(
  ...
  [
    ...
    /* @__PURE__ */ createTextVNode(" JVM 的编译")
  ],
  -1
  /* HOISTED */
);
const _hoisted_5 = {
  href: "https://juejin.cn/post/7008367013223464973",
  target: "_blank",
...
const _hoisted_57 = /* @__PURE__ */ createBaseVNode(
  ...
  [
    ...
    /* @__PURE__ */ createTextVNode(" JIT")
  ],
  -1
  /* HOISTED */
);
const _hoisted_58 = {
  href: "https://www.bilibili.com/video/BV15f4y1q7nK/?share_source=copy_web&vd_source=9c9101455735764adc8a4013f7e3738d",
  target: "_blank",
  rel: "noopener noreferrer"
};
...
const _hoisted_60 = {
  href: "https://zhuanlan.zhihu.com/p/248709769",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_61 = /* @__PURE__ */ createStaticVNode('<h4 id="如何判断一个对象是否还存活" tabindex="-1"><a class="header-anchor" href="#如何判断一个对象是否还存活" aria-hidden="true">#</a> 如何判断一个对象是否还存活</h4><ul><li>引用计数：每个对象有一个引用计数属性，新增一个引用时计数加1，引用释放时计数减1，计数为0时可以回收。此方法简单，无法解决对象相互循环引用的问题。</li><li>可达性分析：从GC Roots开始向下搜索，搜索所走过的路径称为引用链。当一个对象到GC Roots没有任何引用链相连时，则证明此对象是不可用的。不可达对象。</li><li>在Java语言中，GC Roots包括： <ul><li>虚拟机栈中引用的对象。</li><li>方法区中类静态属性实体引用的对象。</li><li>方法区中常量引用的对象。</li><li>本地方法栈中JNI引用的对象。</li></ul></li></ul><h4 id="垃圾收集算法" tabindex="-1"><a class="header-anchor" href="#垃圾收集算法" aria-hidden="true">#</a> 垃圾收集算法</h4><ul><li><p>标记-清除算法：算法分为“标记”和“清除”两个阶段：首先标记出所有需要回收的对象，在标记完成后统一回收掉所有被标记的对象。之所以说它是最基础的收集算法，是因为后续的收集算法都是基于这种思路并对其缺点进行改进而得到的。</p><ul><li>缺点：一个是效率问题，标记和清除过程的效率都不高；另外一个是空间问题，标记清除之后会产生大量不连续的内存碎片，空间碎片太多可能会导致，当程序在以后的运行过程中需要分配较大对象时无法找到足够的连续内存而不得不提前触发另一次垃圾收集动作。</li></ul></li><li><p>复制算法：它将可用内存按容量划分为大小相等的两块，每次只使用其中的一块。当这一块的内存用完了，就将还存活着的对象复制到另外一块上面，然后再把已使用过的内存空间一次清理掉。</p><ul><li>缺点：内存缩小为原来的一半，持续复制长生存期的对象则导致效率降低；在对象存活率较高时就要执行较多的复制操作，效率将会变低。更关键的是，如果不想浪费50%的空间，就需要有额外的空间进行分配担保，以应对被使用的内存中所有对象都100%存活的极端情况，所以在老年代一般不能直接选用这种算法。</li><li>优点：每次都是对其中的一块进行内存回收，内存分配时也就不用考虑内存碎片等复杂情况，只要移动堆顶指针，按顺序分配内存即可，实现简单，运行高效。</li></ul></li><li><p>标记-压缩算法：标记过程仍然与“标记-清除”算法一样，但后续步骤不是直接对可回收对象进行清理，而是让所有存活的对象都向一端移动，然后直接清理掉端边界以外的内存。</p></li><li><p>分代收集算法： 把Java堆分为新生代和老年代，这样就可以根据各个年代的特点采用最适当的收集算法。在新生代中，每次垃圾收集时都发现有大批对象死去，只有少量存活，那就选用复制算法，只需要付出少量存活对象的复制成本就可以完成收集。而老年代中因为对象存活率高、没有额外空间对它进行分配担保，就必须使用“标记-清理”或“标记-整理”算法来进行回收。</p></li></ul><h4 id="垃圾收集器" tabindex="-1"><a class="header-anchor" href="#垃圾收集器" aria-hidden="true">#</a> 垃圾收集器</h4><ul><li><p>Serial收集器：串行收集器是最古老，最稳定以及效率高的收集器，可能会产生较长的停顿，只使用一个线程去回收。新生代、老年代使用串行回收；新生代复制算法、老年代标记-压缩；垃圾收集的过程中会Stop The World（服务暂停）</p></li><li><p>ParNew收集器：ParNew收集器其实就是Serial收集器的多线程版本。新生代并行，老年代串行；新生代复制算法、老年代标记-压缩</p></li><li><p>Parallel收集器：Parallel Scavenge收集器类似ParNew收集器，Parallel收集器更关注系统的吞吐量。可以通过参数来打开自适应调节策略，虚拟机会根据当前系统的运行情况收集性能监控信息，动态调整这些参数以提供最合适的停顿时间或最大的吞吐量；也可以通过参数控制GC的时间不大于多少毫秒或者比例；新生代复制算法、老年代标记-压缩</p></li><li></li></ul><p>Parallel Old 收集器：Parallel Old是Parallel Scavenge收集器的老年代版本，使用多线程和“标记－整理”算法。这个收集器是在JDK 1.6中才开始提供</p><ul><li><p>CMS收集器：CMS（Concurrent Mark Sweep）收集器是一种以获取最短回收停顿时间为目标的收集器。目前很大一部分的Java应用都集中在互联网站或B/S系统的服务端上，这类应用尤其重视服务的响应速度，希望系统停顿时间最短，以给用户带来较好的体验。</p></li><li><p>G1垃圾回收器：G1垃圾回收器将堆内存分割成不同的区域然后并发的对其进行垃圾回收。</p></li></ul><table><thead><tr><th></th><th>新生代GC策略</th><th>老年老代GC策略</th><th>说明</th></tr></thead><tbody><tr><td>组合1</td><td>Serial</td><td>Serial Old</td><td>Serial和Serial Old都是单线程进行GC，特点就是GC时暂停所有应用线程。</td></tr><tr><td>组合2</td><td>Serial</td><td>CMS+Serial Old</td><td>CMS（Concurrent Mark Sweep）是并发GC，实现GC线程和应用线程并发工作，不需要暂停所有应用线程。另外，当CMS进行GC失败时，会自动使用Serial Old策略进行GC。</td></tr><tr><td>组合3</td><td>ParNew</td><td>CMS</td><td>使用 -XX:+UseParNewGC选项来开启。ParNew是Serial的并行版本，可以指定GC线程数，默认GC线程数为CPU的数量。可以使用-XX:ParallelGCThreads选项指定GC的线程数。如果指定了选项 -XX:+UseConcMarkSweepGC选项，则新生代默认使用ParNew GC策略。</td></tr><tr><td>组合4</td><td>ParNew</td><td>Serial Old</td><td>使用 -XX:+UseParNewGC选项来开启。新生代使用ParNew GC策略，年老代默认使用Serial Old GC策略。</td></tr><tr><td>组合5</td><td>Parallel Scavenge</td><td>Serial Old</td><td>Parallel Scavenge策略主要是关注一个可控的吞吐量：应用程序运行时间 / (应用程序运行时间 + GC时间)，可见这会使得CPU的利用率尽可能的高，适用于后台持久运行的应用程序，而不适用于交互较多的应用程序。</td></tr><tr><td>组合6</td><td>Parallel Scavenge</td><td>Parallel Old</td><td>Parallel Old是Serial Old的并行版本</td></tr><tr><td>组合7</td><td>G1GC</td><td>G1GC</td><td>-XX:+UnlockExperimentalVMOptions -XX:+UseG1GC  -XX:MaxGCPauseMillis=50  -XX:GCPauseIntervalMillis=200  -XX:+G1YoungGenSize=512m  -XX:SurvivorRatio=6</td></tr></tbody></table><h2 id="优化" tabindex="-1"><a class="header-anchor" href="#优化" aria-hidden="true">#</a> 优化</h2><h3 id="获取-jvm-数据" tabindex="-1"><a class="header-anchor" href="#获取-jvm-数据" aria-hidden="true">#</a> 获取 jvm 数据</h3><div class="language-she line-numbers-mode" data-ext="she"><pre class="language-she"><code>jmap -F -dump:format=b,file=dumpFile.phrof pid\n</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="jvm-数据分析" tabindex="-1"><a class="header-anchor" href="#jvm-数据分析" aria-hidden="true">#</a> jvm 数据分析</h3>', 13);
const _hoisted_74 = {
  href: "http://www.fastthread.io/",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_75 = {
  href: "https://spotify.github.io/threaddump-analyzer/",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_76 = {
...
const _hoisted_78 = /* @__PURE__ */ createBaseVNode(
  ...
  [
    ...
    /* @__PURE__ */ createTextVNode(" 调优")
  ],
  -1
  /* HOISTED */
);
const _hoisted_79 = {
  href: "https://zhuanlan.zhihu.com/p/488615913",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_80 = /* @__PURE__ */ createBaseVNode(
  ...
  [
    ...
    /* @__PURE__ */ createTextVNode(" 优化工具")
  ],
  -1
  /* HOISTED */
);
const _hoisted_81 = {
  href: "https://zhuanlan.zhihu.com/p/267381560",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_82 = /* @__PURE__ */ createBaseVNode(
  ...
  null,
  [
    /* @__PURE__ */ createBaseVNode("li", null, "jps 虚拟机进程状况工具 jsp [options] [hostid]"),
    /* @__PURE__ */ createBaseVNode("li", null, "jstat 虚拟机统计信息监控工具 jstat [ option vmid [interval[s|ms] [count]] ]"),
    /* @__PURE__ */ createBaseVNode("li", null, "jinfo java 配置信息工具 jinfo [option] pid"),
    /* @__PURE__ */ createBaseVNode("li", null, "jmap java 内存映像工具 jmap [option] vmid"),
    /* @__PURE__ */ createBaseVNode("li", null, "jhat 虚拟机堆转储快照分析工具"),
    /* @__PURE__ */ createBaseVNode("li", null, "jstack java 堆栈跟踪工具 jstack [option] vmid")
  ],
  -1
  /* HOISTED */
);
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("p", null, [
      createBaseVNode("a", _hoisted_17, [
        createTextVNode('Tomcat 是如何打破"双亲委派"机制的?'),
        createVNode(_component_ExternalLinkIcon)
      ])
    ]),
    _hoisted_18,
    ...
    createBaseVNode("p", null, [
      createBaseVNode("a", _hoisted_55, [
        createTextVNode("JVM 执行引擎的作用及工作过程"),
        createVNode(_component_ExternalLinkIcon)
      ])
    ]),
    _hoisted_56,
    ...
    createBaseVNode("p", null, [
      createBaseVNode("a", _hoisted_58, [
        createTextVNode("[Java 性能] 3. 什么是 JIT"),
        createVNode(_component_ExternalLinkIcon)
      ])
    ]),
    _hoisted_59,
    ...
    createBaseVNode("p", null, [
      createBaseVNode("a", _hoisted_74, [
        createTextVNode("http://www.fastthread.io"),
        createVNode(_component_ExternalLinkIcon)
      ])
    ]),
    createBaseVNode("p", null, [
      createBaseVNode("a", _hoisted_75, [
        createTextVNode("https://spotify.github.io/threaddump-analyzer"),
        createVNode(_component_ExternalLinkIcon)
      ])
    ]),
    createBaseVNode("p", null, [
      createBaseVNode("a", _hoisted_76, [
        createTextVNode("http://gceasy.io"),
        createVNode(_component_ExternalLinkIcon)
      ])
    ]),
    createBaseVNode("p", null, [
      createBaseVNode("a", _hoisted_77, [
        createTextVNode("http://heaphero.io"),
        createVNode(_component_ExternalLinkIcon)
      ])
    ]),
    _hoisted_78,
...
const jvmHome_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "jvm-home.html.vue"]]);
export {
  jvmHome_html as default
};
