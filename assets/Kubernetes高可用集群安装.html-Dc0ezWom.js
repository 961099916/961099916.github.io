import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,o,c,b as n,d as s,a,e as l}from"./app-DS2X9Gcs.js";const r={},p=l(`<h2 id="sealos安装集群" tabindex="-1"><a class="header-anchor" href="#sealos安装集群"><span>Sealos安装集群</span></a></h2><h3 id="下载sealos" tabindex="-1"><a class="header-anchor" href="#下载sealos"><span>下载Sealos</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 推荐下载最新版，会修复一些BUG,下载并安装sealos, sealos是个golang的二进制工具，直接下载拷贝到bin目录即可, release页面也可下载</span>
